...
int *Metrics::get(PDF::Font theFont)
{
   int *metrics = NULL;

   switch(theFont)
   {
      case PDF::COURIER               : metrics = courier;               break;
      case PDF::COURIER_BOLD          : metrics = courier_bold;          break;
      case PDF::COURIER_OBLIQUE       : metrics = courier_oblique;       break;
      case PDF::COURIER_BOLD_OBLIQUE  : metrics = courier_boldoblique;   break;
      case PDF::HELVETICA             : metrics = helvetica;             break;
      case PDF::HELVETICA_BOLD        : metrics = helvetica_bold;        break;
      case PDF::HELVETICA_OBLIQUE     : metrics = helvetica_oblique;     break;
      case PDF::HELVETICA_BOLD_OBLIQUE: metrics = helvetica_boldoblique; break;
      case PDF::SYMBOL                : metrics = symbol;                break;
      case PDF::TIMES                 : metrics = times_roman;           break;
      case PDF::TIMES_BOLD            : metrics = times_bold;            break;
      case PDF::TIMES_ITALIC          : metrics = times_italic;          break;
      case PDF::TIMES_BOLD_ITALIC     : metrics = times_bolditalic;      break;
      case PDF::ZAPF_DINGBATS         : metrics = zapfdingbats;          break;
